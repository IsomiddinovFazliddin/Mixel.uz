      ...
      <div className="container mx-auto px-4 py-5">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-2 text-sm md:text-base">
            <Link
              to="/"
              className="text-[#626364] hover:text-Primary transition-colors"
            >
              Home
            </Link>
          ...
          <div className="flex items-center gap-3 self-end sm:self-auto">
            <NavLink
              to="/profil"
              className={({ isActive }) =>
                `text-xl ${isActive ? "text-Primary" : "text-[#909090]"}`
              }
            >
              <IoGridOutline />
            </NavLink>
          ...
          <div className="w-full lg:w-72 lg:border-r border-[#F2F2F2] lg:pr-6">
            ...
            <nav className="flex flex-wrap lg:flex-col gap-2 pb-2 lg:pb-0 ">
              {[
                ...
                <div
                  key={idx}
                  className="flex items-center gap-3 p-3 rounded-xl cursor-pointer hover:bg-gray-100 transition-all min-w-40 lg:min-w-full border lg:border-none"
                >
              ...
              <div className="p-4">
                <form className="space-y-4">
                  ...
                  <div className="flex gap-4">
                    <input
                      className="w-1/2 border border-gray-200 rounded-lg p-2.5 text-sm outline-none"
                      placeholder="House"
                      required
                    />
                    <input
                  ...
                  <div className="flex gap-3">
                    <Button
                      variant="contained"
                      fullWidth
                      sx={{ backgroundColor: "#ED3729", textTransform: "none" }}
                    >
                      Save
                    </Button>
                    <Button
